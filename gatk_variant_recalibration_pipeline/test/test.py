#!/usr/bin/env python
# gatk_variant_recalibration_pipeline 0.0.1 test suite
# Generated by dx-app-wizard.
# See http://wiki.dnanexus.com/Building-Your-First-DNAnexus-App for instructions on how to modify this file.
...
class Testgatk_variant_recalibration_pipeline(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
